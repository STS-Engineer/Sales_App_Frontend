...
export default function Dashboard() {
  ...
  }, [normalizedRfqs, activePhase, activeSubStatus, searchTerm]);
  ...
  useEffect(() => {
    setPage(1);
  }, [activeSubStatus, searchTerm, rowsPerPage]);
                                ...
                                <div className="flex items-start justify-between gap-2">
                                  {phase.subPhases.map((subPhase) => {
                                    ...
                                    const labelClass = isSubActive
                                      ? "mt-1 max-w-[120px] text-center leading-tight text-white font-semibold"
                                      : "mt-1 max-w-[120px] text-center leading-tight text-white/85";

                                    return (
                                    <div
                                      key={subPhase}
                                      className="relative z-10 flex flex-1 flex-col items-center text-[12px] sm:text-[13px] font-medium normal-case tracking-normal text-white/85"
                                    >
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex w-full flex-col gap-1 sm:w-72">
                    <span className="text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-400 invisible">
                      Status
                    </span>
                    <div className="relative">
